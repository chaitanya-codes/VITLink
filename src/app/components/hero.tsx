    ...
    return (
        <div>
            ...
            <div className="flex bg-[url(https://as1.ftcdn.net/v2/jpg/01/16/15/38/1000_F_116153804_EmYnusFGJbk0uGY4J1BeuUX0NfmuEpFJ.jpg)] bg-[#eff1f2] p-6 items-center justify-around mt-[20px] mb-[20px] flex-1 ml-2">
                ...
                <button onClick={() => intership_route()} className='rounded-xl blue-btn w-48'>Find Internships</button>
                <button onClick={() => research_opportunities()} className='rounded-xl blue-btn w-48'>Find Research Opportunities</button>
                <button onClick={() => alumini_connect()} className='rounded-xl blue-btn w-48'>Connect to alumni</button>
            </div>
        </div>
    )
}
